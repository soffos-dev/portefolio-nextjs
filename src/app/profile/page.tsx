...
export default function Profile() {
    ...
    const profileData = {
        ...configProfile,
        socialLinks: { ...socialLinks, ...(configProfile.socialLinks || {}) },
        skills: configSkills.length > 0 ? configSkills : (configProfile.skills || []),
        achievements: achievements.length > 0 ? achievements : (configProfile.achievements || [])
    }
                ...
                <div className="bg-gray-900 border border-gray-700 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6 sm:p-8">
                        <div className="text-center mb-8">
                            <div className="w-32 h-32 mx-auto mb-4 rounded-full border-4 border-blue-400 overflow-hidden bg-gray-800">
                                <svg
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                {processedSkills.map((skillGroup: any, index: number) => (
                                    <div key={index} className="bg-gray-800 border border-gray-600 rounded-lg p-4">
                                        <h3 className="text-yellow-400 font-semibold mb-2 text-sm">{skillGroup.category}</h3>
